...
class Patient extends User {
  ...
  updateStatus(){
    String diagnoseBloodPressureIssue =(healthDataList[healthDataList.length-1].spb!=null && healthDataList[healthDataList.length-1].dbp !=null)? DiagnosisEngine.diagnoseBloodPressureIssue(healthDataList[healthDataList.length-1].spb! as int,healthDataList[healthDataList.length-1].dbp! as int):'';
    ...
    String diagnoseHeartRateIssue =healthDataList[healthDataList.length-1].heartRate!=null? DiagnosisEngine.diagnoseHeartRateIssue(healthDataList[healthDataList.length-1].heartRate! as int):'';
    ...
    String diagnoseTemperatureIssue =healthDataList[healthDataList.length-1].temperature!=null? DiagnosisEngine.diagnoseTemperatureIssue(healthDataList[healthDataList.length-1].temperature!):'';
    ...
    String diagnoseOxygenSaturationIssue =healthDataList[healthDataList.length-1].oxygen!=null? DiagnosisEngine.diagnoseOxygenSaturationIssue(healthDataList[healthDataList.length-1].oxygen!):'';
