              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(watcher.lang.darkMode,style: TextStyle(fontSize: 17,color:watcher.theme.textColor1 ),),
                      Switch(value: watcher.settingDarkmode, onChanged: (isDark){
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(watcher.lang.language,style: TextStyle(fontSize: 17,color:watcher.theme.textColor1 ),),
                      Switch(value: watcher.settingLanguage, onChanged: (isEng){
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(watcher.lang.logOut,style: TextStyle(fontSize: 17,color:watcher.theme.textColor1 ),),
                        const Icon(Icons.power_settings_new_outlined,color: Colors.red,size: 30,)
                      ],
                    ),
                  ),
                ),
