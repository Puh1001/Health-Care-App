...
class InforBar extends StatelessWidget {
  ...
  InforBar(this.groupName,this.list);
  @override
  Widget build(BuildContext context) {
    Row line = Row(children: [Expanded(child: Container(margin: EdgeInsets.symmetric(horizontal: 20),height: 1,color: Colors.grey[300],))]);
    return Container(
...
class Infor extends StatelessWidget {
  ...
  Function onTouch;
  bool canEdit = true;
  Infor(this.property,this.value, {super.key, canEdit = true, required this.onTouch});
  @override
  Widget build(BuildContext context) {
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(property,style: const TextStyle(color: Colors.black,fontSize: 18),),
              SizedBox(
                height: 50,
                child: Row(
                  children: [
                    Text(value,style: const TextStyle(color: Colors.grey,fontSize: 18)),
